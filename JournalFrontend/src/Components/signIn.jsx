  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      window.location.href =
        "https://github.com/login/oauth/authorize?client_id=Iv23liiO4Kvnleoqb6nD&redirect_uri=http://localhost:5173/home&scope=user&state=random_string&scope=public_repo";
    } else {
